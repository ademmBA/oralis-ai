...
import {EmailNotification, EmailNotificationSchema} from "./entities/email-notification.entity";
import {MongooseModule} from "@nestjs/mongoose";

@Module({
  imports: [MongooseModule.forFeature([{ name: EmailNotification.name, schema: EmailNotificationSchema }])],

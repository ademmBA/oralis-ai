  ...
  return (
    <div id="Inspiration" className="min-h-screen px-4 relative overflow-hidden">
      ...
      <div className="text-center z-10 relative max-w-5xl mx-auto px-4 py-12">
        ...
        <p
            className={`mt-6 max-w-3xl mx-auto text-lg md:text-xl font-light flex items-center justify-center gap-2 mb-12 drop-shadow-lg
...
`}
      ...
      <div className="z-10 relative max-w-6xl mx-auto px-4 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <CardContainer isDark={isDark}><BeethovenCard /></CardContainer>
          <CardContainer isDark={isDark}><GhanimAlMuftah /></CardContainer>
          <CardContainer isDark={isDark}><HelenKeller /></CardContainer>
          <CardContainer isDark={isDark}><MunibaMazri /></CardContainer>
          <CardContainer isDark={isDark}><StephenHawking /></CardContainer>
          <CardContainer isDark={isDark}><TahaHusseinCard /></CardContainer>
...
${isDark
          ...
          <h3
              className={`text-2xl md:text-3xl font-bold text-center ${isDark ? "text-white" : "text-gray-900"} mb-8`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h4 className={`font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Sarah Johnson</h4>
                  <p className="text-red-300 text-sm">Visual Impairment</p>
                </div>
              </div>
              <p className={`${isDark ? "text-gray-300" : "text-gray-600"} italic`}>&quot;Hikma Learn&apos;s audio-based courses have transformed how I access education. I&apos;ve gained skills I never thought possible with my visual impairment.&quot;</p>
            </div>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-gray-300 border-2 border-dashed rounded-xl w-12 h-12" />
                <div>
                  <h4 className={`font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Michael Torres</h4>
                  <p className="text-red-300 text-sm">Dyslexia</p>
                </div>
              </div>
              <p className={`${isDark ? "text-gray-300" : "text-gray-600"} italic`}>&quot;The multi-sensory approach at Hikma Learn helped me overcome my reading challenges. I&apos;m now pursuing a degree in graphic design!&quot;</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="z-10 relative max-w-4xl mx-auto px-4 w-full pb-24">
        <div className={`text-center backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-red-500/30
${isDark
          ...
          <p className={`${isDark ? "text-gray-300" : "text-gray-600"} max-w-2xl mx-auto text-lg mb-8`}>
          Join thousands of learners who have discovered their potential through Hikma Learn&#39;s inclusive education platform.
          </p>
          <button
              onClick={handleCommunity}
              className={`px-8 py-4 bg-gradient-to-br from-red-500 via-red-600 to-red-800 hover:from-red-600 hover:via-red-700 hover:to-red-900 ${
                  isDark ? "text-white" : "text-gray-900"
              } font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border border-red-500/30`}
          >

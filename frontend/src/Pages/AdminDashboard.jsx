        ...
        <div className={`backdrop-blur-md rounded-xl p-8 border text-center ${
          ...
          <div className="mb-4">
            ...
            <p className={`mb-4 ${
              ...
              This module would be imported from: <code className={`px-2 py-1 rounded ${
                isDark
    ...
    const fetchCourses = async () => {
      try {
        ...
        setError(`Error fetching courses: ${err.message}. 
          - Ensure the Django server is running at http://localhost:3000/.
          ...
          <div className={`backdrop-blur-md shadow-2xl transition-all duration-300 ${
            ...
            <div className={`p-4 flex flex-col items-center ${
              ...
              {!sidebarCollapsed ? (
                  ...
                  // Collapsed: only show the toggle/collapse button
                  <button
